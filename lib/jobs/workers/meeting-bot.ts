/**
 * Worker meeting-bot — Recall.ai + extraction LLM (action items).
 *
 * Lifecycle :
 ...
 *     appelle extractActionItems (modèle nano) en lazy update.
 ...
 * en pratique. Si le LLM est indisponible, extractActionItems retourne [] via le circuit breaker.
 */
