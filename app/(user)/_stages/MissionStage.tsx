...
export function MissionStage({ mode }: { mode: string }) {
  ...
  return (
    ...
    >
      ...
      {/* Empty state — aucune demande sélectionnée */}
      ...
      {/* Contenu mission — données réelles uniquement */}
      {!loading && !fetchError && mission && (
        <StageLayout
          eyebrow="Demande active"
          title={mission.name}
          subtitle={mission.input.slice(0, 120)}
          actions={<MissionStatusBadge mission={mission} />}
        >
