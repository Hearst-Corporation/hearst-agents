...
export function ServiceIdGlyph({
  ...
  return (
    <span
      className={`inline-flex items-center justify-center border font-mono uppercase tracking-wide text-text-muted border-(--line-strong) bg-transparent shrink-0 ${sz} ${className}`}
      title={`Réf ${id}`}
    >
      {label}
    </span>
