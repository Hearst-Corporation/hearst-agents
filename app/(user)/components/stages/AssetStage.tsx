            ...
            <>
              ...
              {!isImageOnly && (
                <>
                  ...
                  {/* Bloc prompt de génération — affiché uniquement si disponible */}
                  <GenerationPromptBlock
                    prompt={asset.provenance.metadata?.prompt as string | undefined}
 ...
 * Troncation à 200 caractères avec bouton "Voir plus / Réduire".
 * Bouton copier avec retour visuel (2s).
 */
function GenerationPromptBlock({
  prompt,
  expanded,
  copied,
  onToggleExpand,
