  ...
  return useMemo<CommandRow[]>(() => [
    {
      ...
      perform: () => { router.push("/reports"); setOpen(false); },
    },
    {
      id: "nav-missions",
      kind: "action",
      ...
      perform: () => { router.push("/missions"); setOpen(false); },
    },
    {
      id: "nav-runs",
      kind: "action",
      ...
      perform: () => { router.push("/runs"); setOpen(false); },
    },
    {
      ...
      perform: () => { router.push("/notifications"); setOpen(false); },
    },
    {
      id: "nav-apps",
      kind: "action",
      ...
      perform: () => { router.push("/apps"); setOpen(false); },
    },
    {
      id: "nav-marketplace",
      kind: "action",
      ...
      perform: () => { router.push("/marketplace"); setOpen(false); },
    },
    {
      id: "nav-settings",
      kind: "action",
      ...
      perform: () => { router.push("/settings"); setOpen(false); },
    },
    {
      ...
      perform: () => { router.push("/settings/alerting"); setOpen(false); },
    },
    {
      id: "open-archive",
      kind: "action",
      ...
      perform: () => { router.push("/archive"); setOpen(false); },
    },
    {
      id: "open-hospitality",
      kind: "action",
      ...
      perform: () => { router.push("/hospitality"); setOpen(false); },
    },
    {
      id: "open-admin",
      kind: "action",
      ...
      perform: () => { router.push("/admin"); setOpen(false); },
    },
    {
      ...
      perform: () => { router.push("/missions?new=1"); setOpen(false); },
    },
    {
      ...
      perform: () => { router.push("/reports/studio"); setOpen(false); },
    },
    {
      id: "go-cockpit",
      kind: "action",
      ...
      hotkey: "⌘1",
      perform: () => { setStageMode({ mode: "cockpit" } as StagePayload); setOpen(false); },
    },
    {
      id: "go-chat",
      kind: "action",
      ...
      hotkey: "⌘2",
      perform: () => { setStageMode({ mode: "chat" } as StagePayload); setOpen(false); },
    },
    {
      id: "go-asset",
      kind: "action",
    ...
    },
    {
      ...
      hotkey: "⌘4",
      perform: () => { setStageMode({ mode: "browser", sessionId: "" } as StagePayload); setOpen(false); },
    },
    {
      id: "go-meeting",
      kind: "action",
      ...
      hotkey: "⌘5",
      perform: () => { setStageMode({ mode: "meeting", meetingId: "" } as StagePayload); setOpen(false); },
    },
    {
      id: "go-kg",
      kind: "action",
      ...
      hotkey: "⌘6",
      perform: () => { setStageMode({ mode: "kg" } as StagePayload); setOpen(false); },
    },
    {
      id: "go-voice",
      kind: "action",
    ...
    },
    {
      ...
      hotkey: "⌘8",
      perform: () => { setStageMode({ mode: "simulation" } as StagePayload); setOpen(false); },
    },
    {
      id: "go-artifact",
      kind: "action",
      ...
      hotkey: "⌘0",
      perform: () => { setStageMode({ mode: "artifact" } as StagePayload); setOpen(false); },
    },
    {
      ...
      perform: () => { onCompareOpen(); setOpen(false); },
    },
