      ...
      >
        {messages.map((message, idx) => {
          ...
          if (message.role === "user") {
            return (
              <div key={message.id} className="shell-msg-user px-6 py-4 ml-auto max-w-2xl self-end">
          ...
          return (
            <div key={message.id} className="relative shell-msg-ai pl-6 py-2 max-w-3xl self-start">
