...
const PROVIDERS: ProviderEntry[] = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="h-5 w-5" aria-hidden="true">
        <path d="M11.4 24H0V8.8l11.4-2.6V24Z" fill="var(--brand-microsoft-blue)" />
        <path d="M24 5.5V19l-8.8 3.5V1.5L24 5.5Z" fill="var(--brand-microsoft-blue)" />
        <path
          d="M15.2 1.5v21L11.4 24V6.2l-6-1.4L11.4 0l3.8 1.5Z"
          fill="var(--brand-microsoft-dark-blue)"
        />
        <path d="M24 5.5l-8.8-4L11.4 0v6.2L24 5.5Z" fill="var(--brand-microsoft-light-blue)" />
        <path d="M11.4 6.2V24L0 21V8.8l11.4-2.6Z" fill="var(--brand-microsoft-blue)" opacity=".5" />
      </svg>
    ),
  },
];
