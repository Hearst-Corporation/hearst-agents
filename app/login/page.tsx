      ...
      <div className="relative w-full max-w-[var(--width-login-card)]">
        ...
        <div className="rounded-2xl border border-(--border-shell) bg-(--surface-1) px-6 py-8 sm:px-7 sm:py-9 md:px-8 md:py-10">
          ...
          <div className="flex flex-col items-center">
            ...
            {/* Title */}
            <h1 className="mt-4 text-center t-26 font-semibold leading-snug tracking-tight text-text sm:t-30 md:t-34">
              Accédez à votre espace de travail
            </h1>

            {/* Description */}
            <p className="mt-4 text-center t-15 leading-comfortable text-(--text-soft) sm:text-base">
