    ...
    <aside className="flex flex-col h-full bg-bg-elev border-r border-line shrink-0 w-full">
      ...
      >
        ...
        <button
          ...
          className={[
            "flex items-center min-w-0 rounded-(--radius-sm) hover:bg-(--surface-1) transition-colors duration-(--duration-fast) ease-(--ease-standard) group focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-(--danger)/50",
            collapsed
              ? "justify-center size-(--space-10)"
