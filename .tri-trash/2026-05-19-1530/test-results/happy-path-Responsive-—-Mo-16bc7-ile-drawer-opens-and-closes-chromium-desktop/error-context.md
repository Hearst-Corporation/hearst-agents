...
- Name: happy-path.spec.ts >> Responsive — Mobile Viewport >> mobile: drawer opens and closes
- Location: e2e/happy-path.spec.ts:62:7
...
Call log:
  - waiting for locator('button[aria-label=\'Ouvrir le panneau runtime\']')
