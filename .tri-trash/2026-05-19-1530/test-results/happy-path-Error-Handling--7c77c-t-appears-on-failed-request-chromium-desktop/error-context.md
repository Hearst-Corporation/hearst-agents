...
- Name: happy-path.spec.ts >> Error Handling — Toast Visibility >> error toast appears on failed request
- Location: e2e/happy-path.spec.ts:90:7
...
Call log:
  - waiting for locator('[data-testid=\'chat-input\'] textarea, [data-testid=\'chat-input\'] input').first()
...
- generic [active] [ref=e1]:
  - generic [ref=e3]:
    - generic [ref=e4]:
      - generic [ref=e5]:
        - generic [ref=e6]: Hearst OS
        - generic [ref=e7]: Accès sécurisé
        - heading "Accédez à votre espace de travail" [level=1] [ref=e8]
        - paragraph [ref=e9]: Connectez-vous via votre fournisseur d'identité professionnel.
      - generic [ref=e10]:
        - button "Continuer avec Google" [ref=e11]:
          - img [ref=e12]
          - generic [ref=e17]: Continuer avec Google
        - button "Continuer avec Outlook" [ref=e18]:
          - img [ref=e19]
          - generic [ref=e25]: Continuer avec Outlook
      - paragraph [ref=e26]: En continuant, vous vous authentifiez via votre fournisseur d'entreprise.
    - generic [ref=e27]:
      - link "Confidentialité" [ref=e28] [cursor=pointer]:
        - /url: https://hearstcorporation.io/privacy
      - generic [ref=e29]: ·
      - link "Conditions" [ref=e30] [cursor=pointer]:
        - /url: https://hearstcorporation.io/terms
      - generic [ref=e31]: ·
      - link "Aide" [ref=e32] [cursor=pointer]:
