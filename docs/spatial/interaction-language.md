...
:root {
  /* États halo */
  --spatial-halo-hover: rgba(255, 250, 240, 0.3);
  --spatial-halo-selected: rgba(255, 255, 255, 0.6);
  --spatial-halo-pinned: rgba(0, 229, 204, 0.5); /* accent-teal */
  --spatial-halo-error: rgba(217, 168, 108, 0.7); /* ambre */
