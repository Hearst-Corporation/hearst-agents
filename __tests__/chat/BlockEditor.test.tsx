...
describe("BlockEditor", () => {
  it("monte avec la valeur initiale dans la textarea", () => {
    render(<BlockEditor initialValue="bonjour" onSave={() => {}} onCancel={() => {}} />);
  ...
  it("appelle onCancel quand on tape ESC", () => {
    ...
    render(<BlockEditor initialValue="x" onSave={() => {}} onCancel={onCancel} />);
  ...
  it("appelle onSave avec la valeur courante via Cmd+Enter", () => {
    const onSave = vi.fn();
    render(<BlockEditor initialValue="hello" onSave={onSave} onCancel={() => {}} />);
    const ta = screen.getByLabelText("Éditer le block") as HTMLTextAreaElement;
  ...
  it("supporte Ctrl+Enter (Linux/Windows)", () => {
    const onSave = vi.fn();
    render(<BlockEditor initialValue="abc" onSave={onSave} onCancel={() => {}} />);
    const ta = screen.getByLabelText("Éditer le block");
  ...
  it("clic sur 'Enregistrer' déclenche onSave avec la valeur courante", () => {
    const onSave = vi.fn();
    render(<BlockEditor initialValue="initial" onSave={onSave} onCancel={() => {}} />);
    const ta = screen.getByLabelText("Éditer le block") as HTMLTextAreaElement;
  ...
  it("ne déclenche PAS onSave sur Enter sans modificateur", () => {
    const onSave = vi.fn();
    render(<BlockEditor initialValue="x" onSave={onSave} onCancel={() => {}} />);
    const ta = screen.getByLabelText("Éditer le block");
